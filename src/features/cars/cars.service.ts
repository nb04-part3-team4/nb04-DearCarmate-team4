...
import CarRepository from '@/features/cars/cars.repository.js';
import {
  CarRequestDto,
  CarResponseDto,
  CreateCarRequestDto,
...
import { companyRepository } from '@/features/companies/company.repository.js';
import {
  BadRequestError,
  NotFoundError,
} from '@/shared/middlewares/custom-error.js';
