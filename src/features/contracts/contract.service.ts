...
// } from '@/features/contracts/contract.dto';
// import { userRepository } from '@/features/users/user.repository';
// import prisma, { TxClient } from '@/shared/middlewares/prisma';
// import {
//   ContractStatus,
//   ContractWithRelations,
//   CarStatus,
...
//     carStatus: CarStatus,
//   ): Promise<void> {
//     await CarRepository.update(tx, carId, {status: carStatus});
//   }
...
//     const resetCarStatus: CarStatus = 'possession';
//     await prisma.$transaction(async (tx) => {
//       await this.updateCarStatusInTransaction(tx, existingContract.carId, resetCarStatus);
//     })
